...
test_cases = [
    knapsack_cylp.read_test(test_id) + (get_correct_ans(test_id),test_id) 
...
def test_solver(N, b, a, c, total_cost_ans, test_id):
    ans, best_cost, total_cost, total_weight = knapsack_cylp.solve(N, b, a, c)
    knapsack_cylp.save_test(test_id, ans, best_cost, total_cost, total_weight, N)
